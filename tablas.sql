EXPLAIN coderhouse_gamers.class;
DESCRIBE coderhouse_gamers.class;

-- creando tabla con un motor diferente INNODB POR DEFECTO
USE CLASE7;
...
DESCRIBE coderhouse_gamers.GAME;
...
CREATE TABLE producto(
   ...
   descripcion VARCHAR(245) DEFAULT "PRODUCTO DESCONOCIDO",
